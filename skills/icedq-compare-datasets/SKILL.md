...
`reconciliation-patterns.md`. Exception detail on request via `get_checks_exception_report` /
`get_exception_report_url`; deep analysis hands off to `icedq-run-and-report`.
